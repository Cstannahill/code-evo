      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis
            ...
            tick={{ fill: "var(--ctan-text-muted)" }}
            tickFormatter={(value: string) =>
              value.charAt(0).toUpperCase() + value.slice(1)
            }
          />
          <YAxis className="text-xs text-muted-foreground" tick={{ fill: "var(--ctan-text-muted)" }} />
          <Tooltip
            contentStyle={{
              backgroundColor: "#232329", // Use main dark bg
              borderColor: "#262629", // Use dark border
              borderRadius: "0.5rem",
            ...
            content={({ active, payload }) => {
              if (active && payload && payload.length) {
                ...
                return (
                  <div className="p-3 space-y-1 bg-main-bg rounded-md shadow-lg border border-gray-700 text-primary">
                    ...
                    {tooltipData.patterns &&
                      tooltipData.patterns.length > 0 && (
                        <div className="text-xs text-muted-foreground mt-2 pt-1 border-t border-gray-600">
          ...
          />
          <Legend wrapperStyle={{ color: "var(--ctan-text-muted)", paddingTop: "10px" }} />
