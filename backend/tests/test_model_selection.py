...
async def _async_test_model_selection():
    """Async implementation of the model selection flow test"""
    ...
    try:
        ...
        print(
            f"   Multi-model available: {status.get('multi_model_service_available')}"
        )
...
def test_model_selection():
    ...
    asyncio.run(_async_test_model_selection())
